					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="">
									<a class="nav-stylehead" href="faq2.php">Faqs</a>
								</li>
								<li class="dropdown">
									...
									<ul class="dropdown-menu agile_short_dropdown">
										<li>
											<a href="icon2.php">Web Icons</a>
										</li>
										<li>
											<a href="typograph2.php">Typography</a>
										</li>
									</ul>
								</li>
								<li class="">
									<a class="nav-stylehead" href="contac2.php">Contact</a>
								</li>
							</ul>
						</div>
					</div>
